#!/usr/bin/env bash
#
# Phase 7: Bootstrap ArgoCD onto a fresh k3s cluster.
#
# After this runs, ArgoCD is operational but no applications are deployed yet.
# That gate is intentional — it allows restore-volumes.sh to pre-populate
# Longhorn PVCs before any stateful services start.
#
# Flow:
...
#
# Next step: provision/restore-volumes.sh
set -euo pipefail
